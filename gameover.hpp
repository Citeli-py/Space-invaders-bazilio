...
int gameover(BITMAP* bmp, int pontos)
{
    ...
    while (!key[KEY_ESC])
    {
		...
		textprintf_ex(sprite, font, 310, 315, makecol(255,255,255), -1, "Aperte ESC para sair");
		textprintf_ex(sprite, font, 280, 330, makecol(255,255,255), -1, "Aperte ENTER para jogar de novo");
